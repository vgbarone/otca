{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyNvNZIfTO+y+gPgWqzT+hWz",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/vgbarone/otca/blob/main/app.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
